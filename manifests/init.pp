class superset (
  ...
  String           $venv_dir                        = '/home/deployer/virtualenvs',
  String           $owner                           = 'deployer',
  String           $group                           = 'deployer',
  ...
  String           $lastname                        = 'bi',
  String           $email                           = 'bi@letgo.com',
  String           $dburi                           = 'postgresql+psycopg2://superset:superset@biprosuperset.chdlenylqwad.us-east-1.rds.amazonaws.com/superset',
